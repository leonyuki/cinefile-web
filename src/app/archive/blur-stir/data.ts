...
export const traceTrashData: EventData = {
  ...
  statement: `異国での留学生活を経験した東京出身の５人のアーティストが、\nそれぞれの視点から、日常に潜む違和感を、\n写真、映像、インスタレーション、ダンスパフォーマンス、\nなどのインタラクティブな仕掛けを通じて表現する。\n\n異なる文化圏での生活は、日々少しずつ、\n我々の「眼」に微細な変化を与えている。\n東京という住み慣れた街の日常が、いま彼らに一体どんな風に見えているのだろうか。\n普段の生活の中で「違和」なるものは、生まれては消えていき、見過ごされる。\nそういう瞬間的な時間を生きている。\n異質なものが交わることで生まれる新たな視点や創造性を探り、\n観客に自身の固定観念を問い直す機会を提供する。\n偶発的なアート体験を通じて、違和の中に潜む可能性や美しさを再認識する場を創出する。`,
  artists: [
    {
      members: [
        { 
