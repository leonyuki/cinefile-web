import posterBlurStir from '../../imports/image.png';
import posterFaellesspisning from '../../imports/image-1.png';
import posterTrouvaille from '../../imports/image-2.png';
import posterHazama from '../../imports/image-3.png';
import hazamaGroup from '../../imports/image-5.png';
import copenhagenOnigiri from '../../imports/image-6.png';
import parisScreening from '../../imports/image-7.png';
...
まだ見ぬ可能性に溢れる日仏の若手アーティストの自主制作・短編アニメーション6作品を上映。様々な人が1枚のスクリーンに目を向け、語り合うトークセッションを通じて、互いの文化や価値観の違いを感じ、それを乗り越えていくことを目指した。`,
    ...
    image: posterTrouvaille,
    gallery: [parisScreening],
    instagramPosts: [
...
様々な角度からデンマークと日本の文化の違いに踏み込み、深い対話を目指した。`,
    ...
    image: posterFaellesspisning,
    gallery: [copenhagenOnigiri],
    instagramPosts: [
